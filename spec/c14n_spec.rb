...
describe "Paul's tests, translated from Perl" do
  ...
  describe 'Things to keep or encode' do
    #
    #  encoding
    #
...
# is(c14n_url("http://www.example.com/commas,and-\"quotes\"-make-CSV-harder-to-'awk'"), 'http://www.example.com/commas%2cand-%22quotes%22-make-csv-harder-to-%27awk%27', "commas and quotes");
  it 'encodes square brackets and pipes' do
    BLURI('http://www.example.com/problematic-in-curl[]||[and-regexes]').canonicalize!.to_s.should == 'http://www.example.com/problematic-in-curl%5b%5d%7c%7c%5band-regexes%5d'
  end
...
#     "non-reserved character percent decoding");
  ...
  #  is(c14n_url("http://www.example.com?a=1&c=3&b=2", '*'),
  #    "http://www.example.com?a=1&b=2&c=3", "query string wildcard value");

  it 'sorts query_string values' do
  ...
  # is(c14n_url("http://www.example.com?a=you're_dangerous", '*'),
  #   "http://www.example.com?a=you%27re_dangerous", "escape query string values");
